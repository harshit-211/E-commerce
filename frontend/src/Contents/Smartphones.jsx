...
function Smartphones({ limit, extraCard, maxPrice, isFilterActive }) {
  const navigate = useNavigate();
  const [allPhones, setAllPhones] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    fetch("https://e-commerce-3-zvas.onrender.com/user/get/phones", {
      method: "GET",
            ...
            <>
              ...
              >
                ...
                {displayedPhones.map((phone, index) => (
                  <div
                    onClick = {() => navigate(`/phone/details/${phone._id}`)}
              ...
              {limit && allPhones.length > limit && (
                ...
                >
                  <div className="flex justify-center mt-8">
                    <button
                      onClick={() => navigate("/all/smartphones")}
