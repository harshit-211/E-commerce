...
function Shoes({ limit, extraCard, maxPrice, isFilterActive }) {
    ...
    const displayedShoes = (() => {
      if(!isFilterActive) {
        return limit ? allShoes.slice(0, limit) : allShoes;
      }
      return allShoes
        .filter(item => {
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                <>
                  ...
                  >
                    {extraCard}
                    {displayedShoes.map((shoes, index) => (
                      <div
                        onClick = {() => navigate(`/shoes/details/${shoes._id}`)}
                      ...
                      >
                        ...
                        <p className="mt-3 sm:mt-4 text-gray-300 text-sm sm:text-base">
                          {shoes.companyName} {shoes.name} {shoes.colour} ...
                        </p>
                        <p className="mt-2 text-gray-400 text-sm">{shoes.price}</p>
